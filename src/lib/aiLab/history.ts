...
// Pulls a configurable lookback window (7 days–1 year) from the public-data gateway
...
export type LookbackDays = 7 | 30 | 90 | 365;

export const LOOKBACK_OPTIONS: LookbackDays[] = [7, 30, 90, 365];
