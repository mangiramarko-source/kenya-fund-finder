...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-card/95 backdrop-blur-md border-b border-border">
      {/* Desktop top bar: search + dark mode + sign in only */}
      <div className="hidden md:flex h-14 items-center justify-end gap-2 px-6">
        <SearchDialog />
        <Button
          variant="ghost"
          size="icon"
      ...
      <div className="md:hidden">
        <div className="flex h-16 items-center justify-between px-4 relative">
          ...
          <Link to="/" className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center h-9 w-9 rounded-xl bg-accent text-accent-foreground">
        ...
        <div className="flex justify-center px-4 pb-1.5 pt-1 bg-card/95">
        ...
        <div className="px-4 pb-2 pt-0.5 border-b border-border bg-card/95">
          <SearchDialog />
        </div>
      </div>
