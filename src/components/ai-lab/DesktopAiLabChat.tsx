...
export default function DesktopAiLabChat() {
  ...
  return <>
    <div className="fixed inset-0 z-50 hidden bg-black/5 backdrop-blur-[1px] md:block" onClick={() => setOpen(false)} aria-hidden="true" />
    <section role="dialog" aria-modal="false" aria-label="AI Lab chat" className="fixed bottom-5 right-5 z-[51] hidden h-[min(620px,calc(100vh-2.5rem))] w-[min(410px,calc(100vw-2.5rem))] flex-col overflow-hidden rounded-[24px] border border-border/80 bg-background/95 shadow-2xl backdrop-blur-xl md:flex">
