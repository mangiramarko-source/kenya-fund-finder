    ...
    <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
      <section>
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          Fund Finder Kenya ("we", "our", or "the Platform") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website. By using this Platform, you agree to the practices described in this policy.
        </p>
      </section>
