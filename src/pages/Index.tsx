...
const Index = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  return (
    <div ref={ref} className="min-h-screen">
      ...
      <div className={`md:hidden sticky top-16 z-20 bg-background border-b border-border/50 pb-3 transition-shadow duration-200 ${scrolled ? "shadow-[0_4px_12px_-2px_hsl(var(--background)/0.8),0_2px_6px_-2px_hsl(0_0%_0%/0.3)]" : ""}`}>
