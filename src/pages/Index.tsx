  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="border-b border-border bg-card">
        ...
        <p className="hidden sm:block text-[10px] text-muted-foreground text-center py-1.5 border-t border-border/40 mt-2">Yields are gross annual effective rates before 15% withholding tax.</p>
      </div>
