...
3. If migration fails on missing `logo_url`, run **`repair-funds-logo-url.sql`** in the SQL Editor, or `node scripts/apply-repair-schema.mjs supabase/migrations/20260530150000_repair_funds_logo_url.sql`
4. Run quick migration (all market data, no news):
